            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Booking Core by')); ?> <a href="<?php echo e(__('#')); ?>" target="_blank"><?php echo e(__('Silicon Soft IT')); ?></a>
                    </div>
                    <div class="col-md-6">
...
<?php /**PATH /home/silicons/public_html/modules/Layout/admin/app.blade.php ENDPATH**/ ?>